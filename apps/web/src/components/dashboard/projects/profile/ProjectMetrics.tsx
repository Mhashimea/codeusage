...
import { Coins, Zap, ListTodo, FileCode, Users, TrendingUp } from "lucide-react";
...
export function ProjectMetrics({ stats }: ProjectMetricsProps) {
  ...
  const avgCostPerTask = stats.totalTasks > 0 ? stats.totalCost / stats.totalTasks : 0;
        ...
        <Card>
          <CardContent className="pt-5 pb-5">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-2xl font-bold">{stats.uniqueDevelopers}</p>
        ...
        <Card>
          <CardContent className="pt-5 pb-5">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-2xl font-bold text-emerald-500">{formatCost(avgCostPerTask)}</p>
                <p className="text-xs text-muted-foreground">Avg Cost/Task</p>
              </div>
            </div>
          </CardContent>
        </Card>
