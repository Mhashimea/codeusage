...
function ProviderIcon({
  ...
  switch (id) {
    case "claude_code":
      return <ClaudeIcon className={cn("h-4 w-4", className)} />;
    case "codex":
      return <CodexIcon className={cn("h-4 w-4", className)} />;
    default:
      return (
...
export function ProviderBadge({
  ...
  if (!provider) {
    return (
      ...
      >
        <ProviderIcon id={providerId} className="h-3.5 w-3.5" />
...
export { ClaudeIcon, CodexIcon, ProviderIcon };
